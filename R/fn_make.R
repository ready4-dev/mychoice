...
#' @importFrom ready4 make_local_path_to_dv_data write_dv_fl_to_loc make_prompt
    ...
    write_to_1L_chr = character(0), year_1L_int = 2016) 
{
    ...
    ready4::write_dv_fl_to_loc(ds_ui_1L_chr = X@dv_ds_nm_1L_chr, 
        fl_nm_1L_chr = fl_nm_1L_chr, repo_fl_fmt_1L_chr = repo_fl_fmt_1L_chr, 
        save_type_1L_chr = save_type_1L_chr, server_1L_chr = X@dv_server_1L_chr, 
        dest_path_1L_chr = path_1L_chr, consent_1L_chr = consent_1L_chr)
